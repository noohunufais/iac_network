...
from net_apps import load_ipam_file, get_device_info

def configure_device(device_name, config_data):

    # Setup Jinja2 environment
    env = Environment(loader=FileSystemLoader('/home/student/iac_network/templates'))
...
if __name__ == "__main__":
    ...
    with open('/home/student/iac_network/variables/config.yaml') as file:
