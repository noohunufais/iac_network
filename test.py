...
snmp_template = env.get_template('snmp.j2')
logging_template = env.get_template('logging.j2')
...
snmp_config = snmp_template.render(snmp=config_data['snmp'])
logging_config = logging_template.render(logging=config_data['logging'])
